...
# 3. Compile Setup.exe
print("3. Compiling LeagueOfCustoms-Setup-v0.7.0.exe...")
setup_exe = os.path.join(dist_dir, 'LeagueOfCustoms-Setup-v0.7.0.exe')
res = subprocess.run([
    csc, '/nologo', '/optimize+', '/target:winexe',
    r'/win32icon:assets\app.ico',
...
portable_zip = os.path.join(dist_dir, 'LeagueOfCustoms-v0.7.0-Portable.zip')
portable_files = [
