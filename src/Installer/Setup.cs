...
namespace LeagueOfCustoms.Installer
{
    ...
    public class SetupForm : Form
    {
        ...
        public SetupForm()
        {
            this.Text = "League of Customs v0.6.2 Setup";
        ...
        private void BuildUI()
        {
            ...
            {
                Text = "v0.6.2 \u2014 Custom Game Companion & Team Randomizer",
            ...
            if (isUpgrade)
            {
                this.Text = "League of Customs v0.6.2 Update";
                lblTitle.Text = "UPDATE LEAGUE OF CUSTOMS";
                lblSub.Text = string.Format("Upgrade existing installation{0} to v0.6.2", string.IsNullOrEmpty(existingVer) ? "" : " (v" + existingVer + ")");
            }
            ...
            {
                Text = isUpgrade ? "Existing installation detected. Click 'Update' to upgrade to v0.6.2." : "Ready to install. Click 'Install' to begin.",
